...
const styles = StyleSheet.create({
  ...
  copyBtn: { flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 6, backgroundColor: '#1E3A8A', borderRadius: 12, paddingVertical: 12, paddingHorizontal: 8 },
  copyBtnText: { flexShrink: 1, fontSize: 13, color: '#FFFFFF', fontWeight: '700', textAlign: 'center' },
  shareBtn: { flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 4, backgroundColor: '#16A34A', borderRadius: 12, paddingVertical: 12, paddingHorizontal: 8 },
  shareBtnText: { flexShrink: 1, fontSize: 13, color: '#FFFFFF', fontWeight: '700', textAlign: 'center' },
