...
function JobSupportChat({ route, navigation }) {
  ...
  // No chat exists yet — a vendor can't start one.
  if (!chat) {
    return (
      <View style={styles.container}>
        <Header navigation={navigation} title="Support Chat" showBack />
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>The customer or their relationship manager starts this chat. You'll be able to reply here once they do.</Text>
        </View>
      </View>
    );
  }
