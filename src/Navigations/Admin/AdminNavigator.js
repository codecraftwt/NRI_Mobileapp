...
// Personal Info / Address / Change Password are role-agnostic — they're driven
// by the generic PUT /auth/profile and /auth/change-password endpoints, so the
// same NRI screens work unchanged for an admin account.
      ...
      {state.routes.map((route, index) => {
        ...
        const onPress = () => {
          ...
          if (rootScreen) {
            ...
            // was left on so re-tapping never reopens a stale deep screen.
