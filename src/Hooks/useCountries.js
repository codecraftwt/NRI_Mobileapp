...
// expect, plus loading/error state for the caller to render around it. Full
// country objects (incl. phoneCode + flagEmoji) drive the dial-code flag
// pickers; `countryNames` feeds the plain name selectors.
