...
// `cityId` (a resolved numeric geo-city id) requests vendor availability +
// real pricing for that city; pricing.vendorPriced / recurringVendorPriced are
// null until it's supplied.
export function useServiceGroups(categoryName, stateName, cityId = null) {
  ...
  useEffect(() => {
    ...
    const currentFilter = { categoryId, stateId: stateId || null, cityId: cityId || null };
  ...
  }, [categoryId, stateId, cityId, groups.status, dispatch]);
